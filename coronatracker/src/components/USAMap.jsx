...
class USAMap extends Component {
    ...
    render() {
       ...
       <g className="state">
        ...
        <path onMouseMove={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} id="Colorado" d="M380.2 235.5l-36-3.5-79.1-8.6-2.2 22.1-7 50.4-1.9 13.7 34 3.9 37.5 4.4 34.7 3 14.3.6z">
          <title>Colorado</title>
        </path>
        <path onMouseMove={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} id="Connecticut" d="M852 190.9l3.6-3.2 1.9-2.1.8.6 2.7-1.5 5.2-1.1 7-3.5-.6-4.2-.8-4.4-1.6-6-4.3 1.1-21.8 4.7.6 3.1 1.5 7.3v8.3l-.9 2.1 1.7 2.2z">
          <title>Connecticut</title>
        </path>
        <path onMouseMove={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} id="Delaware" d="M834.4 247.2l-1 .5-3.6-2.4-1.8-4.7-1.9-3.6-2.3-1-2.1-3.6.5-2 .5-2.3.1-1.1-.6.1-1.7 1-2 1.7-.2.3 1.4 4.1 2.3 5.6 3.7 16.1 5-.3 6-1.1z">
        ...
        <path onMouseMove={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} id="Kansas" d="M485.9 259.5l-43.8-.6-40.6-1.2-21.7-.9-4.3 64.8 24.3 1 44.7 2.1 46.3.6 12.6-.3.7-35-1.2-11.1-2.5-2-2.4-3-2.3-3.6.6-3 1.7-1.4v-2.1l-.8-.7-2.6-.2-3.5-3.4z">
          <title>Kansas</title>
        </path>
        ...
        <path onMouseMove={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} id="North Dakota" d="M471 126.4l-.4-6.2-1.8-7.3-1.8-13.61-.5-9.7-1.9-3.18-1.6-5.32V70.68l.6-3.85-1.8-5.54-28.6-.59-18.6-.6-26.5-1.3-25.2-2.16-.9 14.42-4.7 50.94 56.8 3.9 56.9 1.7z">
        ...
        <path onMouseMove={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} id="New Mexico" d="M270.2 429.4l-16.7-2.6-1.2 9.6-15.8-2 6-39.7 7-53.2 4.4-30.9 34 3.9 37.4 4.4 32 2.8-.3 10.8-1.4-.1-7.4 97.7-28.4-1.8-38.1-3.7.7 6.3z">
          <title>New Mexico</title>
        </path>
        <path onMouseMove={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} id="Nevada" d="M123.1 173.6l38.7 8.5 26 5.2-10.6 53.1-5.4 29.8-3.3 15.5-2.1 11.1-2.6 16.4-1.7 3.1-1.6-.1-1.2-2.6-2.8-.5-1.3-1.1-1.8.1-.9.8-1.8 1.3-.3 7.3-.3 1.5-.5 12.4-1.1 1.8-16.7-25.5-42.1-62.1-12.43-19 8.55-32.6 8.01-31.3z">
          <title>Nevada</title>
        </path>
        ...
        <path onMouseMove={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} id="Rhode Island" d="M873.6 175.7l-.8-4.4-1.6-6 5.7-1.5 1.5 1.3 3.4 4.3 2.8 4.4-2.8 1.4-1.3-.2-1.1 1.8-2.4 1.9-2.8 1.1z">
        ...
        <path onMouseMove={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} id="Utah" d="M228.4 305.9l24.6 3.6 1.9-13.7 7-50.5 2.3-22-32.2-3.5 2.2-13.1 1.8-10.6-34.7-6.1-12.5-2.5-10.6 52.9-5.4 30-3.3 15.4-1.7 9.2z">
          <title>Utah</title>
        </path>
        ...
        <path onMouseMove={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} id="Vermont" d="M832.7 111.3l2.4 6.5.8 5.3-1 3.9 2.5 4.4.9 2.3-.7 2.6 3.3 1.5 2.9 10.8v5.3l11.5-2.1-1-1.1.6-1.9.2-4.3-1-1.4.2-4.7.8-9.3v-8.5l-1.1-1.8v-1.6l2.8-1.1 3.5-4.4v-3.6l-1.9-2.7-.3-5.79-26.1 6.79z">
          <title>Vermont</title>
        </path>
        ...
        <path onMouseMove={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} id="Wyoming" d="M353 161.9l-1.5 25.4-4.4 44-2.7-.3-83.3-9.1-27.9-3 2-12 6.9-41 3.8-24.2 1.3-11.2 48.2 7 59.1 6.5z">
          <title>Wyoming</title>
        </path>
        <g id="District of Columbia">
          <title>District of Columbia</title>
          <path id="District of Columbia" d="M801.8 253.8l-1.1-1.6-1-.8 1.1-1.6 2.2 1.5z"/>
