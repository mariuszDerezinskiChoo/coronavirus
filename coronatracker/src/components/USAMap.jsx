...
class USAMap extends Component {
    ...
    constructor(props) {
      super(props)
      //this.handleMouseEnter = this.props.changeState;
    }
    ...
    handleMouseEnter = (e) => {
      if (this.props.handleChangeState) {
        this.props.handleChangeState(e.currentTarget.id);
      }
      
    }
    // handleMouseEnter(e) {
    //   this.props.changeState(e.currentTarget.id);
    ...
    handleMouseClick = (e) => {
      if (this.props.handleSelectState) {
        this.props.handleSelectState(e.currentTarget.id);
      }
    }
